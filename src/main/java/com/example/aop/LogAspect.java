...
public class LogAspect {
    ...
    // @Around("execution(* com.example.controller.*Controller.*(..)) or execution(*
    // com.example.mapper.*Mapper.*(..))")
    // public Object sessionLog(ProceedingJoinPoint joinPoint)
    // throws Throwable {
    ...
    // System.out.println(className + "," + methodName + "," + pathName + "," +
    // queryName);
    // if (!pathName.startsWith("/member/login") &&
    // !pathName.startsWith("/member/logout")) {
    // httpSession.setAttribute("BACKURL", httpSession);
    // }
    // // System.out.println((String) httpSession.getAttribute("BACKURL"));
